...
\end{landscape}
\end{verbatim}
W programie TexStudio podaczas kompikowania dokumentu, w którym znajduje się obraz eps pojawia się komunikat błędu. Należy wówczas zmienić w opcjach (jednorazowo) domyślny kompilator.
