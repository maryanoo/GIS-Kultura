...
<qgis version="2.16.3" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{74c8539b-32b0-4457-b14c-f050b106a872}">
      <rule description="autostrady" filter=" &quot;highway&quot; IN ( 'motorway' , 'motorway_link')" key="{2e819615-a01f-4127-9b69-b985f8f6b3ec}" symbol="0" label="autostrady"/>
      <rule scalemaxdenom="7000000" description="drogi ekspresowe" filter="&quot;highway&quot; IN ('primary', 'primary_link' , 'trunk', 'trunk_link')" key="{75c640e8-8bff-46cb-8fa7-c0446b8f2637}" symbol="1" scalemindenom="1400000" label="ekspresowe"/>
      <rule scalemaxdenom="1400000" description="drogi ekspresowe" filter="&quot;highway&quot; IN ('primary', 'primary_link' , 'trunk', 'trunk_link')" key="{7c0786cd-c824-4ded-ab91-bdfd7bcccd6c}" symbol="2" scalemindenom="1" label="ekspresowe"/>
      <rule scalemaxdenom="1800000" description="drogi powtrórzone" filter="&quot;highway&quot; IN ('secondary', 'secondary_link')" key="{6f4f8c4f-cecb-477d-99c9-078457cb28ea}" symbol="3" scalemindenom="600000" label="drogi wojewódzkie"/>
      <rule scalemaxdenom="600000" description="drogi powtrórzone" filter="&quot;highway&quot; IN ('secondary', 'secondary_link')" key="{968c3729-b13a-4cd0-a259-356886ad49a2}" symbol="4" scalemindenom="1" label="drogi wojewódzkie"/>
      <rule scalemaxdenom="600000" filter="&quot;highway&quot; IN ( 'tertiary' )" key="{1a282e83-b976-44a2-b6a8-8b8f168c6216}" symbol="5" scalemindenom="1" label="lokalne"/>
      <rule scalemaxdenom="50000" filter="&quot;highway&quot; IN ( 'residential' ,'service' )" key="{60784338-94aa-4f05-aa39-b9f823b6f87b}" symbol="6" scalemindenom="1" label="lokalne dojazdowe"/>
      <rule scalemaxdenom="30000" filter=" &quot;highway&quot; IN ( 'footway' , 'living_street' , 'pedestrian' )" key="{bc919f4c-ce98-48ce-ab32-707989d316d5}" symbol="7" scalemindenom="1" label="pozostałe"/>
      <rule checkstate="0" filter="&quot;bridge&quot; = 'yes'" key="{cd8305a2-c60e-4ea1-9d2d-6918b81f8a50}" symbol="8" label="most"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="6">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="191,164,164,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/ShapeDraw" value="1~~0~~~~name"/>
    ...
    <property key="labeling/shapeSVGFile" value="/usr/share/qgis/svg/backgrounds/background_square_rounded.svg"/>
