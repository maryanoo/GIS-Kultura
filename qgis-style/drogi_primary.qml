...
<qgis version="2.16.3" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{74c8539b-32b0-4457-b14c-f050b106a872}">
      <rule description="autostrady" filter=" &quot;highway&quot; IN ( 'motorway' , 'motorway_link', 'trunk', 'trunk_link')" key="{2e819615-a01f-4127-9b69-b985f8f6b3ec}" symbol="0" label="autostrady"/>
      <rule description="drogi ekspresowe" filter="&quot;highway&quot; IN ('primary', 'primary_link' )" key="{7c0786cd-c824-4ded-ab91-bdfd7bcccd6c}" symbol="1" label="ekspresowe"/>
      <rule description="drogi powtrórzone" filter="&quot;highway&quot; IN ('secondary', 'secondary_link')" key="{968c3729-b13a-4cd0-a259-356886ad49a2}" symbol="2" label="drogi wojewódzkie"/>
      <rule filter="highway IN ( 'residential' , 'tertiary' )" key="{1a282e83-b976-44a2-b6a8-8b8f168c6216}" symbol="3" label="pozostałe"/>
    </rules>
    <symbols>
