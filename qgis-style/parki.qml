...
<qgis version="2.16.3" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{ce2673fd-c822-4164-b0b4-baa74e8c0022}">
      <rule scalemaxdenom="100000" filter=" &quot;landuse&quot; =  'forest' " key="{3dc07413-2edf-400b-8a87-8bdef9340371}" symbol="0" scalemindenom="1" label="lasy"/>
      <rule scalemaxdenom="300000" filter="&quot;landuse&quot; IS  NOT 'forest' " key="{698c96c3-03ab-406e-9cbb-cdfb6cc8d878}" symbol="1" scalemindenom="1" label="parki_obiekty_lokalne"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="1">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="236,255,189,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="labeling/obstacleType" value="1"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;name&quot;" sortOrder="0">
    <columns>
      ...
      <column width="483" hidden="0" type="field" name="name"/>
      ...
      <column width="408" hidden="0" type="field" name="tags"/>
